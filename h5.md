...
![qBittorrent sha256](check-sums.png?raw=true "qBittorrent checksums")
![7zip check sha256](7zip-checksums-2.png?raw=true "7zip chec checksums")
...
_onionlinksanifwu.onion_ gave a list of sites with very little description of
